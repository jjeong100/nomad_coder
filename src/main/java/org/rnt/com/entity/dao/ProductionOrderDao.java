...
public class ProductionOrderDao extends BaseDao {
	...
	public final String ENTITY_NAME = "mpo009";
	...
	public RtnVO select(ProductionOrderVO param) {
		RtnVO rtn = new RtnVO();
		try {
			ProductionOrderVO vo = sqlSession.selectOne(ENTITY_NAME+".select", param);
			rtn.setObj(vo);
		} catch (Exception e) {
			return setRtnVO(rtn, ENTITY_NAME+GlvConst.STR_SPACE+GlvConst.RC_DB_SEL_ERR_MSG, e.getMessage()); 
		}
	...
	public RtnVO selectQmInfo(ProductionOrderVO param) {
		RtnVO rtn = new RtnVO();
		try {
			ProductionOrderVO vo = sqlSession.selectOne(ENTITY_NAME+".selectQmInfo", param);
			rtn.setObj(vo);
		} catch (Exception e) {
			return setRtnVO(rtn, ENTITY_NAME+GlvConst.STR_SPACE+GlvConst.RC_DB_SEL_ERR_MSG, e.getMessage()); 
		}
	...
	public RtnVO searchList(ProductionOrderVO param) {
		RtnVO rtn = new RtnVO();
		try {
			List<ProductionOrderVO> list = sqlSession.selectList(ENTITY_NAME+".searchList", param);
			rtn.setObj(list);
		} catch (Exception e) {
			return setRtnVO(rtn, ENTITY_NAME+GlvConst.STR_SPACE+GlvConst.RC_DB_SEL_ERR_MSG, e.getMessage()); 
		}
	...
	public RtnVO searchMonthList(ProductionOrderVO param) {
		RtnVO rtn = new RtnVO();
		try {
			List<ProductionOrderVO> list = sqlSession.selectList(ENTITY_NAME+".searchMonthList", param);
			rtn.setObj(list);
		} catch (Exception e) {
			return setRtnVO(rtn, ENTITY_NAME+GlvConst.STR_SPACE+GlvConst.RC_DB_SEL_ERR_MSG, e.getMessage()); 
		}
