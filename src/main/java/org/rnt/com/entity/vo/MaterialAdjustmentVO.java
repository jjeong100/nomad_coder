...
public class MaterialAdjustmentVO extends SearchDefaultVO implements Serializable {
    private static final long serialVersionUID = 4845991127688295728L;
    ...
    public String getPresidenNm() {
        return presidenNm;
    }
    public void setPresidenNm(String presidenNm) {
        this.presidenNm = presidenNm;
    }
