...
@Controller
public class MaterialSubulController extends BaseController {
    ...
    @RequestMapping(value = "/materialSubulListPage.do")
    public String materialSubulListPage(@ModelAttribute("search")SubulInVO search, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
        //---------------------------------------------------------------------
        ...
        RtnVO rtn = materialMenuService.searchSubulList(search);
        RtnVO rtnTotCnt = materialMenuService.searchSubulListTotCnt(search);
        ...
        return "/material/materialSubulList";
    }
