...
public class UserController extends BaseController {
    ...
    public String userListPage(@ModelAttribute("search")WorkerVO search, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
        //---------------------------------------------------------------------
        // paging set
        //---------------------------------------------------------------------
    ...
    @RequestMapping(value = "/userDtlPage.do")
    public String userDtlPage(@ModelAttribute("search")WorkerVO search, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
        RtnVO rtn = null;
        ...
        wedEnd(request, rtn, model);
        return "/system/userDtl";
    }
    
    @RequestMapping(value = "/userSaveAct.do")
    public ModelAndView userSaveAct(@ModelAttribute("obj")WorkerVO obj, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
