...
@Controller
public class ProductionMonthCloseController extends BaseController {
    ...
    @RequestMapping(value = "/productionMonthCloseListPage.do")
    public String productionMonthCloseListPage(@ModelAttribute("search")MonthCloseInVO search, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
        //---------------------------------------------------------------------
        ...
        RtnVO rtn = productionMenuService.searchMonthCloseList(search);
        RtnVO rtnTotCnt = productionMenuService.searchMonthCloseListTotCnt(search);
        ...
        return "/production/productionMonthCloseList";
    }
    
    
    @RequestMapping(value = "/productionCreateMonthClose.do")
    public ModelAndView productionCreateMonthClose(@ModelAttribute("obj")MonthCloseInVO obj, HttpServletRequest request, ModelMap model)  throws Exception {
        webStart(request);
        ...
        if ("Y".equals(obj.getMagamYn())) {
            ...
            //-----------------------------------------------------------------
            RtnVO selRtn = productionMenuService.selectMinUnCloseMonth(obj);
            ...
            //-----------------------------------------------------------------
            RtnVO selRtn = productionMenuService.selectMaxCloseMonth(obj);
            if (selRtn.getRc() == GlvConst.RC_SUCC) {
