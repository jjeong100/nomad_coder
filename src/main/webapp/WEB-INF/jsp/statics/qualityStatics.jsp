    ...
    <script type="text/javaScript" language="javascript" defer="defer"> 
        ...
        (function($) {
            $(function(){
                        ...
                        success: function(data) {
                            ...
                            if (data.rtn.rc == 0) {
                                ...
                                var options = {
                                    'width': '100%',
                                    'height': 550,
                                    'chartArea': {left:60, right:110, 'width': '100%', 'height': '90%'}
                                };
                ...
                drawTot = function() {
                    $.ajax({
                        url : "<c:url value='/selectQualityTotStaticsData.do'/>",
                        type: 'POST',
                        data: $('#searchForm').serialize(),
                        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                        context:this,
                        ...
                        success: function(data) {
                            $("#layoutSidenav").loadingClose();
                            if (data.rtn.rc == 0) {
                            	$("#titleMsg").html('월별 재고수량&nbsp;&nbsp;&nbsp;&nbsp;기준년도&nbsp;:&nbsp;'+fn_add_comma(data.rtn.obj.baseYearTotRate)+'&nbsp;&nbsp;&nbsp;&nbsp;대상년도&nbsp;:&nbsp;'+fn_add_comma(data.rtn.obj.compYearTotRate));
                            }
                        },
                        error: function(request, status, error){
                            console.log("code = "+ request.status + " message = " + request.responseText + " error = " + error);
