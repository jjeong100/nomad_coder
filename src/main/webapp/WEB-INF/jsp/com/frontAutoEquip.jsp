        ...
        (function($) {
            $(function(){
                ...
                drawProductionChart = function() { 
                    $.ajax({
                        url : "<c:url value='/getFrontAutoEquipChartData.do'/>",
                        type: 'POST',
                ...
                drawDashBoard = function() {
                    $.ajax({
                        url : "<c:url value='/getFrontAutoEquipSummaryData.do'/>",
                        type: 'POST',
                        data: $('#searchForm').serialize(),
                        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                        context:this,
...
//                     alert($(this).val());
                    frm.action = "<c:url value='/frontAutoEquipPage.do'/>";
                    frm.submit();
                });
                       ...
                       <div class="card mb-4">
                        <div id="dataTable_filter" class="dataTables_wrapper">
                               <form:form commandName="search" id="searchForm" name="searchForm">
                                   ...
                                   <div style="float:left;"><h1 class="mt-4 mb-1">프런트자동화</h1></div>
