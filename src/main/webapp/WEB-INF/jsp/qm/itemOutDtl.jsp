                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/itemOutSaveAct.do'/>"
                                                    ,$('#objForm').serialize(),'삭제 되었습니다.'
                                                    ,'searchForm'
                                                    ,"<c:url value='/itemOutListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control3" id="iteminDt" name="iteminDt" type="text" value="${itemInVo.iteminDt}" readonly />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
					...
					<div class="card mb-4" style="margin-top: 30px;">
						...
						<div class="card-body">
							<div class="form-row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control3" id="itemoutDt" name="itemoutDt" type="text" value="${rtn.obj.itemoutDt}" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
							...
							<div id="viewUpdateEnable" class="col-md-12" style="display: none;">
								<div class="form-row">
									<div class="col-md-6">
										<div id="btnEnableUpdateCancel" class="btn btn-dark btn-block">수정 취소</div>
									</div>
									<div class="col-md-6">
										<div id="btnUpdate" class="btn btn-dark btn-block">수정 완료</div>
									</div>
								</div>
							</div>
							<!-- 생성 버튼 -->
