...
<script>
    $(document).ready(function() {
        ...
        $("#btnPrintTranSpec").click(function() {
            ...
            if( chkCnt > 12 ) {
                cfAlert("거래 명세서 출력은 12개까지만 가능합니다.");
                return false;
            }
...
//                 data: {businNo:"XXX-XX-XXXXX"},
                ...
                success: function(data) {
                    ...
                    $("span[name='dynamic-custNm']").text(fn_undefined(data.rtn.obj.custNm));
                    $("span[name='dynamic-custAddr']").text(fn_undefined(data.rtn.obj.custAddr));
                    $("span[name='dynamic-custCeoNm']").text(fn_undefined(data.rtn.obj.custCeoNm));
                    $("span[name='dynamic-custBusinNo']").text(fn_undefined(data.rtn.obj.custBusinNo));
                    $("span[name='dynamic-custBusinCond']").text(fn_undefined(data.rtn.obj.custBusinCond));
                    $("span[name='dynamic-custPartsCategory']").text(fn_undefined(data.rtn.obj.custPartsCategory));
                },
            ...
            $("input[name=rowCheckBox]:checked").each(function(idx, obj) {
                ...
                var itemPrice     = Number($("#"+$(this).val()+"_perPrice").text());
                var totPrice      = Number(outsideQty) * Number(itemPrice);
//                 var vat           = Number(itemPrice) * 0.1;//부가세
                var vat           = Number(totPrice) * 0.1;//부가세
                
                if(array01[index] == null || array01[index] == "undefined") array01[index] = "";
                else  array01[index] += "<br>";
                
                if(array02[index] == null || array02[index] == "undefined") array02[index] = "";
                else  array02[index] += "<br>";
                
                if(array03[index] == null || array03[index] == "undefined") array03[index] = "";
                else  array03[index] += "<br>";
                
                if(array04[index] == null || array04[index] == "undefined") array04[index] = "";
                else  array04[index] += "<br>";
                
                if(array05[index] == null || array05[index] == "undefined") array05[index] = "";
                else  array05[index] += "<br>";
                
                if(array06[index] == null || array06[index] == "undefined") array06[index] = "";
                else  array06[index] += "<br>";
                
                if(array07[index] == null || array07[index] == "undefined") array07[index] = "";
                else  array07[index] += "<br>";
              
                array01[index] += itemNm;
//                 array02[index] += itemKind;
                array02[index] += itemNo;
                array03[index] += cfAddComma(outsideQty);
                array04[index] = "MM";
                array05[index] += cfAddComma(itemPrice);
                array06[index] += cfAddComma(totPrice);
                array07[index] += cfAddComma(vat);
            ...
            for(var i=0;i<array01.length;i++) {
                ...
                $("span[name='dynamic-row" + i + "-col1']").html(fn_undefined(array01[i]));//품명
                $("span[name='dynamic-row" + i + "-col2']").html(fn_undefined(array02[i]));//규격
                $("span[name='dynamic-row" + i + "-col3']").html(fn_undefined(array03[i]));//수량
                $("span[name='dynamic-row" + i + "-col4']").html(fn_undefined(array04[i]));//단위
                $("span[name='dynamic-row" + i + "-col5']").html(fn_undefined(array05[i]));//단가
                $("span[name='dynamic-row" + i + "-col6']").html(fn_undefined(array06[i]));//공급가
                $("span[name='dynamic-row" + i + "-col7']").html(fn_undefined(array07[i]));//부가세
            }
             ...
             <div id="provider">
                ...
                <tbody>
                  ...
                  <tr>                      
                    ...
                    <td class="text-center" style="width:8%"><span class="title9bs1">상호</span></td>
                    <td class="text-center" style="width:16%"><span class="title9" name="dynamic-custNm"></span></td>
                    <td class="text-center" style="width:8%"><span class="title9bs1">성명</span></td>
                  ...
                  <tr> <!-- style="border-bottom-style:double;" -->
                    ...
                    <c:forEach var="i" begin="0" end="5">
                        ...
                        <tr style="height: 45px;background-color:${color}">
                            <td  colspan="3" class="padding03 text-center" style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col1"></span></td>
                            <td  colspan="2" class="padding03 text-center" style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col2"></span></td>
                            <td class="padding03 text-right"  style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col3"></span></td>
                            <td class="padding03 text-center" style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col4"></span></td>
                            <td class="padding03 text-right"  style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col5"></span></td>
                            <td class="padding03 text-right"  style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col6"></span></td>
                            <td class="padding03 text-right"  style="color:black;font-size: 0.8rem;"><span name="dynamic-row${i}-col7"></span></td>
                        </tr>
                    </c:forEach>
