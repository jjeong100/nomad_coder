        ...
        (function($) {
            $(function(){
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/deviceDtlPage.do'/>";
                    frm.submit();
                });
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">시설 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="deviceCd" value="${search.deviceCd}"/>
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="시설명" id="searchDeviceNm" name="searchDeviceNm" value="${search.searchDeviceNm}" />
								                   </div>
								               </form:form>
                                           </div> 
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="device_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">시설코드</th>
	                                                  <th id="device_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 25%;">시설명</th>
	                                                  <th id="device_ip" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 20%;">IP</th>
	                                                  <th id="device_bigo" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 20%;">비고</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="device_cd">${item.deviceCd}</span></td>
					                                    <td class="text-ellipsis"><span class="device_nm"><a href="javascript:fn_go_dtl_page('${item.deviceCd}')">${item.deviceNm}</a></span></td>
					                                    <td class="text-ellipsis"><span class="device_ip">${item.deviceIp}</span></td>
					                                    <td class="text-ellipsis"><span class="device_bigo">${item.deviceBigo}</span></td>
					                                </tr>
					                              </c:forEach>
