...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer"> 
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/noticeSaveAct.do'/>"
                                		            ,$('#objForm').serialize(),'삭제 되었습니다.'
                                		            ,'searchForm'
                                		            ,"<c:url value='/noticeListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
        ...
        function fn_submit_validation() {
        	if($("#title").val().trim() == ''){
                alert(MSG_COM_ERR_001.replace("[@]", " : 제목"));
                $("#title").focus();
                return false;
            }
            if($("#contentTextArea").val().trim() == ''){
                alert(MSG_COM_ERR_001.replace("[@]", " : 내용"));
                $("#contentTextArea").focus();
                return false;
            }
            document.objForm.content.value = $("#contentTextArea").val();
            return true;
        }
        ...
        function fn_btn_show_hide() {
        	if (document.objForm.crudType.value == 'R') {
                ...
                $('#viewCreate').hide();
                $('#contentTextArea').attr("readOnly",false);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                   ...
                   <input type="hidden" name="content" value="${rtn.obj.content}"/>
                   
                   <div class="card mb-4" style="margin-top:30px;">
                       <div class="card-header">
                           <h3 class="text-center font-weight-light my-1">공지사항정보</h3>           
                       </div>
                       <div class="card-body">
                           <div class="form-row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       ...
                                       <input class="form-control" id="title" name="title" type="text" value="${rtn.obj.title}" placeholder="제목을 입력하세요"/>
                                   </div>
                               </div>
                           </div>
                           ...
                           <div class="form-row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <label class="small mb-1" for="contentTextArea">내용</label>
                                       <textarea class="form-control" id="contentTextArea" rows="15">${rtn.obj.content}</textarea>
                                   </div>
                               </div>
                           </div>
...
<form:form commandName="search" id="searchForm" name="searchForm">
    ...
    <input type="hidden" name="searchTitle" value="${search.searchTitle}"/>
</form:form>
<script>
