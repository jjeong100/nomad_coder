        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/dataBackupListPage.do'/>";
                    frm.submit();
		        });
                ...
                // 백업파일 다운로드
                //-------------------------------------------------------------
                $("span[name='btnBackupDownload']").click(function() {
                	downloadFile("<c:url value='/downloadBackupFile.do'/>?backupSeq=" + $(this).data("key"));
                });
                                           ...
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input class="form-control2" id="searchToDate" name="searchToDate" type="text" value="${search.searchToDate}" placeholder="데이타보관 종료일자"/>
								                   </div>
								                   
								                   <div style="float: right; margin: 6px 5px;">
								                       <input class="form-control2" id="searchFromDate" name="searchFromDate" type="text" value="${search.searchFromDate}" placeholder="데이타보관 시작일자"/>
								                   </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="backup_dt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">백업일자</th>
	                                                  <th id="backup_nm" class="no-sort" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">백업파일</th>
	                                                  <th id="backup_div_nm" class="no-sort" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">백업대상구분</th>
	                                                  <th id="backup_download" class="no-sort" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">다운로드</th>
                                                  </tr>
                                              </thead>
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="backup_dt">${item.backupDt}</span></td>
					                                    <td class="text-ellipsis"><span class="backup_nm">${item.backupNm}</span></td>
					                                    <td class="text-ellipsis"><span class="backup_div_nm">${item.backupDivNm}</span></td>
					                                    <td class="text-ellipsis"><span name="btnBackupDownload" class="btn btn-success btn-sm" data-key="${item.backupSeq}" title="다운로드">다운로드</span></td>
					                                </tr>
					                              </c:forEach>
