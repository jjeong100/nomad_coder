        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/noticeListPage.do'/>";
                    frm.submit();
		        });
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/noticeDtlPage.do'/>";
                    frm.submit();
                });
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">공지사항 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="noticeSeq" value="${search.noticeSeq}"/>
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="제목" id="searchTitle" name="searchTitle" value="${search.searchTitle}" />
								                   </div>
								               </form:form>
                                           </div> 
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="title" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 30%;">제목</th>
	                                                  <th id="update_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">작성자</th>
	                                                  <th id="update_dt_str" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 20%;">작성일시</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="title"><a href="javascript:fn_go_dtl_page('${item.noticeSeq}')">${item.title}</a></span></td>
					                                    <td class="text-ellipsis"><span class="update_nm">${item.updateNm}</span></td>
					                                    <td class="text-ellipsis"><span class="update_dt_str">${item.updateDtStr}</span></td>
					                                </tr>
					                              </c:forEach>
