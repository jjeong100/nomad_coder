...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer"> 
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/userGroupSaveAct.do'/>"
                                		            ,$('#objForm').serialize(),'삭제 되었습니다.'
                                		            ,'searchForm'
                                		            ,"<c:url value='/userGroupListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
        ...
        function fn_submit_validation() {
        	if($("#scode").val().trim() == ''){
                alert(MSG_COM_ERR_001.replace("[@]", " : 그룹코드"));
                $("#scode").focus();
                return false;
            }
            if($("#codeNm").val().trim() == ''){
                alert(MSG_COM_ERR_001.replace("[@]", " : 그룹명"));
                $("#codeNm").focus();
                return false;
            }
                           ...
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="scode">그룹코드</label>
                                       <input class="form-control" id="scode" name="scode" type="text" value="${rtn.obj.scode}" placeholder="그룹코드를 입력하세요">
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="codeNm">그룹명</label>
                                       <input class="form-control" id="codeNm" name="codeNm" type="text" value="${rtn.obj.codeNm}" placeholder="그룹명을 입력하세요">
                                   </div>
                               </div>
                           </div>
                       </div>
...
<form:form commandName="search" id="searchForm" name="searchForm">
    ...
    <input type="hidden" name="searchCodeNm" value="${search.searchCodeNm}"/>
</form:form>
<script>
