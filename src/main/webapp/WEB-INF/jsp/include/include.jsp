...
<link type="text/css" rel="stylesheet" href="<c:url value='/resource/css/select2.min.css'/>" />
<script type="text/javascript" src="<c:url value='/resource/js/ext/jquery/select2.min.js'/>" ></script>
