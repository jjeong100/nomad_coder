        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/itemGetApi.do'/>";
                    frm.submit();
		        });
                ...
                $('#btnExcelDown').click(function() {
                	$.ajax({
                        url : "<c:url value='/itemGetApiExcel.do'/>",
                        type: 'POST',
                ...
                $('#fileupload').fileupload({
                    url : "<c:url value='/itemSetApiExcel.do'/>",
                           ...
                           <div class="form-row">
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       ...
                                       <input class="form-control" id="url" name="url" type="text" value="/itemApi.do" readonly />
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="form-group">
                   ...
                   <div class="card mb-4" style="margin-top:30px;">
                       ...
                       <div id="getView" class="card-body">
                           ...
                           <div class="form-row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <label class="small mb-1" for="searchItemNm">제품명</label>
                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="제품명" id="searchItemNm" name="searchItemNm" value="${search.searchItemNm}" />
                                   </div>
                               </div>
                           </div>
                           </form:form>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
													...
													<th id="item_type_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 14%;">제품구분</th>
													<th id="cust_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 8%;">대표 고객사</th>
													<th id="write_id" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 9%;">등록자</th>
													<th id="write_dt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 9%;">등록일</th>
                                                  </tr>
                                              </thead>
                                                  ...
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                       ...
                                                       <td class="text-ellipsis"><span class="rnum">${item.rnum}</span></td>
														...
														<td class="text-ellipsis"><span class="item_nm"><a href="javascript:fn_go_dtl_page('${item.itemCd}')">${item.itemNm}</a></span></td>
														<td class="text-ellipsis"><span class="item_type_cd">${item.itemTypeNm}</span></td>
