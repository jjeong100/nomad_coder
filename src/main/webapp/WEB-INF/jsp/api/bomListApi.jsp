        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/bomListGetApi.do'/>";
                    frm.submit();
		        });
                ...
                $('#btnExcelDown').click(function() {
                	$.ajax({
                        url : "<c:url value='/bomListGetApiExcel.do'/>",
                        type: 'POST',
                ...
                $('#fileupload').fileupload({
                    url : "<c:url value='/bomListSetApiExcel.do'/>", 
                           ...
                           <div class="form-row">
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       ...
                                       <input class="form-control" id="url" name="url" type="text" value="/bomListApi.do" readonly />
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="form-group">
                           ...
                           <div class="form-row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       ...
                                       <input type="text" class="form-control col-xs-2 input-lg radius" size="35" placeholder="제품명" id="searchItemNm" name="searchItemNm" value="${search.searchItemNm}" />
                                   </div>
                               </div>
                           </div>
                           </form:form>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">  
                                                  <tr role="row">
                                                      ...
                                                      <th id="oper_seq" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">공정순번</th>
                                                      <th id="oper_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">공정코드</th>
                                                      <th id="oper_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">공정명</th>
                                                      <th id="oper_upcd_seq" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">상위공정순번</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="oper_upcd_seq">${item.operUpcdSeq}</span></td>
                                                    </tr>
                                                  </c:forEach>
