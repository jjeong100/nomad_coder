        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/equipGetApi.do'/>";
                    frm.submit();
		        });
                ...
                $('#btnExcelDown').click(function() {
                	$.ajax({
                        url : "<c:url value='/equipGetApiExcel.do'/>",
                        type: 'POST',
                ...
                $('#fileupload').fileupload({
                    url : "<c:url value='/equipSetApiExcel.do'/>", 
                           ...
                           <div class="form-row">
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       ...
                                       <input class="form-control" id="url" name="url" type="text" value="/equipApi.do" readonly />
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="form-group">
                   ...
                   <div class="card mb-4" style="margin-top:30px;">
                       ...
                       <div id="getView" class="card-body">
                           ...
                           <div class="form-row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <label class="small mb-1" for="searchEquipNm">장비명</label>
                                       <input type="text" class="form-control col-xs-2 input-lg radius" size="35" placeholder="장비명" id="searchEquipNm" name="searchEquipNm" value="${search.searchEquipNm}" />
                                   </div>
                               </div>
                           </div>
                           </form:form>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">  
                                                  <tr role="row">
                                                      ...
                                                      <!-- <th id="equip_no" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">장비번호</th> -->
                                                      <th id="equip_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">장비명</th>
                                                      <th id="equip_pg" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">프로그램</th>
                                                      <th id="equip_model_no" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">장비모델번호</th>
                                                      <th id="equip_corp_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">제조사</th>
                                                      <th id="equip_get_dt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">구입일자</th>
                                                      <th id="equip_ip" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">설비IP</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <%-- <td class="text-ellipsis"><span class="equip_no">${item.equipNo}</span></td> --%>
                                                        <td class="text-ellipsis"><span class="equip_nm">${item.equipNm}</span></td>
                                                        <td class="text-ellipsis"><span class="equip_pg">${item.equipPg}</span></td>
                                                        <td class="text-ellipsis"><span class="equip_model_no">${item.equipModelNo}</span></td>
                                                        ...
                                                        <td class="text-ellipsis"><span class="equip_ip">${item.equipIp}</span></td>
                                                    </tr>
                                                  </c:forEach>
