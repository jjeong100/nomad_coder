        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/equipTypeGetApi.do'/>";
                    frm.submit();
		        });
                ...
                $('#btnExcelDown').click(function() {
                	$.ajax({
                        url : "<c:url value='/equipTypeGetApiExcel.do'/>",
                        type: 'POST',
                           ...
                           <div class="form-row">
                               ...
                               <div class="col-md-4">
                                   <div class="form-group">
                                       ...
                                       <input class="form-control" id="url" name="url" type="text" value="/equipTypeApi.do" readonly />
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="form-group">
                   ...
                   <div class="card mb-4" style="margin-top:30px;">
                       ...
                       <div id="getView" class="card-body">
                           ...
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="searchEquipNm">설비명</label>
                               ...
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="searchEquipTypeNm">설비유형</label>
                                       <input type="text" class="form-control col-xs-2 input-lg radius" size="35" placeholder="설비유형" id="searchEquipTypeNm" name="searchEquipTypeNm" value="${search.searchEquipTypeNm}" />
                                   </div>
                               </div>
                           </div>
                           </form:form>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">  
                                                  <tr role="row">
                                                      ...
                                                      <th id="equip_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">설비명</th>
                                                      <th id="equip_type_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">설비유형</th>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="equip_type_nm">${item.equipTypeNm}</span></td>
