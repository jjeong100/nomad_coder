        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/equipSumListPage.do'/>";
                    frm.submit();
                });
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
                                                      ...
                                                      <th id="work_cnt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">실적건수</th>
                                                      <th id="error_cnt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">오류건수</th>
                                                      <th id="error_rate" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">오류율</th>
                                                  </tr>
                                              </thead>
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="work_cnt"><fmt:formatNumber value="${item.workCnt}" pattern="#,###,###"/></span></td>
                                                        <td class="text-ellipsis"><span class="error_cnt"><fmt:formatNumber value="${item.errorCnt}" pattern="#,###,###"/></span></td>
                                                        <td class="text-ellipsis"><span class="error_rate"><fmt:formatNumber value="${item.errorRate}" pattern="#,###,###.##"/> %</span></td>
                                                    </tr>
                                                  </c:forEach>
