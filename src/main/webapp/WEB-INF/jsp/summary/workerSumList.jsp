        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/workerSumListPage.do'/>";
                    frm.submit();
		        });
                                           ...
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input class="form-control" id="searchSabunNm" name="searchSabunNm" type="text" value="${search.searchSabunNm}" placeholder="작업자명"/>
								                   </div>
								                   <div style="float: right; margin: 6px 5px;">
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="ymd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">일자</th>
	                                                  <th id="sabun_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">작업자명</th>
	                                                  ...
	                                                  <th id="bad_rate" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">불량률</th>
                                                  </tr>
                                              </thead>
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="ymd">${item.ymd}</span></td>
					                                    ...
					                                    <td class="text-ellipsis"><span class="actok_qty"><fmt:formatNumber value="${item.actokQty}" pattern="###,###"/></span></td>
					                                    <td class="text-ellipsis"><span class="actbad_qty"><fmt:formatNumber value="${item.actbadQty}" pattern="###,###"/></span></td>
					                                    <td class="text-ellipsis"><span class="bad_rate">${item.badRate} %</span></td>
					                                </tr>
					                              </c:forEach>
