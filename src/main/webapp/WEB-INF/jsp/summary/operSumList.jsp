    ...
    (function($) {
        $(function() {
            ...
            $('#btnSearch').click(function() {
                ...
                frm.action = "<c:url value='/operSumListPage.do'/>";
                frm.submit();
            });
                                        ...
                                        <div id="dataTable_filter" class="dataTables_wrapper">
                                            <form:form commandName="search" id="searchForm" name="searchForm">
                                                ...
                                                <div style="float:right;margin:6px 5px;width:200px;">
                                                    <select class="form-control2" id="searchOperCd" name="searchOperCd">
                                                        <option value="">공정선택</option>
                                                        <c:forEach items="${oper_list}" var="item" varStatus="status">
                                                            <c:choose>
                                                                <c:when test="${item.operCd == search.searchOperCd}">
                                                                    <option value="${item.operCd}" selected>${item.operNm}</option>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <option value="${item.operCd}">${item.operNm}</option>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:forEach>
                                                    </select>
                                        ...
                                        <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout: fixed;">
                                            <thead class="thead-dark">
                                                <tr role="row">
                                                    ...
                                                    <th id="po_calldt"  class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">작업지시일자</th>
                                                    <th id="item_nm"    class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:30%;">제품명</th>
                                                    <th id="po_qty"     class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">수량</th>
                                                    <th id="actok_qty"  class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">양품수</th>
                                                    <th id="check_qty"  class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">검품수</th>
                                                    <th id="inok_qty"   class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">완제품입고수</th>
                                                    <th id="out_qty"    class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width:10%;">완제품출하수</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="check_qty">${item.checkQty}</span></td>
                                                        <td class="text-ellipsis"><span class="inok_qty">${item.inokQty}</span></td>
                                                        <td class="text-ellipsis"><span class="out_qty">${item.outQty}</span></td>
                                                    </tr>
                                                </c:forEach>
