	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div class="container-fluid">
				...
				<!-- title                                                                                                                    -->
				<!-- ======================================================================================================================== -->
				<h1 class="mt-4">${searchInsp.searchInspTypeCd == 'JJ' ? '자주':'패트롤'}검사</h1>
				<!-- ========================================================================================================================= -->
				<!-- taable list                                                                                                              -->
				<!-- ======================================================================================================================== -->
				<div class="card mb-4">
					<div class="card-header">
						...
						<div id="btnClose" class="btn btn-primary btn-sm mr-2" style="float: right;">닫기</div>
						<div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">검사 추가</div>
					</div>
					<div class="card-body">
