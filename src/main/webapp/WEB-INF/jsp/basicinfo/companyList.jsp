        ...
        (function($) {
            $(function(){
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/companyDtlPage.do'/>";
                    frm.submit();
                });
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">거래처 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="거래처명" id="custNm" name="custNm" value="${search.custNm}" />
								                   </div>
								               </form:form>
                                           </div> 
                                       </div>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="cust_nm"><a href="javascript:fn_go_dtl_page('${item.custCd}')">${item.custNm}</a></span></td>
					                                    <td class="text-ellipsis"><span class="cust_type_cd">${item.custTypeNm}</span></td>
					                                    <td class="text-ellipsis"><span class="mat_type_cd">${item.matTypeNm}</span></td>
