        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/comCodeListPage.do'/>";
                    frm.submit();
		        });
                                           ...
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="대분류코드" id="searchComCodeNm" name="searchComCodeNm" value="${search.searchComCodeNm}" />
								                   </div>
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="코드명" id="searchCodeNm" name="searchCodeNm" value="${search.searchCodeNm}" />
								                   </div>
								               </form:form>
                                           </div>
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="factory_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 8%;">공장코드</th>
	                                                  <th id="bcode" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">대분류코드</th>
	                                                  <th id="scode" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">소분류코드</th>
	                                                  <th id="code_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">코드명</th>
	                                                  <th id="sort_order" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">코드순서</th>
	                                                  <th id="bigo" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">비고</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="factory_cd">${item.factoryCd}</span></td>
					                                    <td class="text-ellipsis"><span class="bcode">${item.bcode}</span></td>
					                                    <td class="text-ellipsis"><span class="scode">${item.scode}</span></td>
					                                    <td class="text-ellipsis"><span class="code_nm">${item.codeNm}</span></td>
					                                    <td class="text-ellipsis"><span class="sort_order">${item.sortOrder}</span></td>
					                                    <td class="text-ellipsis"><span class="bigo">${item.bigo}</span></td>
					                                </tr>
					                              </c:forEach>
