            ...
            $(function(){
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/storeHouseSaveAct.do'/>"
                                                    ,$('#objForm').serialize(),'삭제 되었습니다.'
                                                    ,'searchForm'
                                                    ,"<c:url value='/storeHouseListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
                ...
                $('#btnUpdate').click(function() {
                    if($("#workshopCd").val().trim() == ''){
                        alert(MSG_COM_ERR_001.replace("[@]", " : 창고 코드"));
                        $("#workshopCd").focus();
                        return false;
                    }
                    if($("#workshopNm").val().trim() == ''){
                        alert(MSG_COM_ERR_001.replace("[@]", " : 창고명"));
                        $("#workshopNm").focus();
                        return false;
                    }
                    if($("#areaCd").val().trim() == ''){
                        alert(MSG_COM_ERR_001.replace("[@]", " : 구역"));
                        $("#areaCd").focus();
                        return false;
                    }
                           ...
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="workshopCd">창고코드</label>
                                       <input class="form-control" id="workshopCd" name="workshopCd" type="text" value="${rtn.obj.workshopCd}" placeholder="창고코드를 입력하세요"/>
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="workshopNm">창고명</label>
                                       <input class="form-control" id="workshopNm" name="workshopNm" type="text" value="${rtn.obj.workshopNm}" placeholder="창고명을 입력하세요"/>
                                   </div>
                               </div>
                           </div>
                       </div>
                   ...
                   <div class="card mb-4" style="margin-top:30px;">
                       ...
                       <div class="card-body">
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="areaCd">구역</label>
                                       <select class="form-control2" id="areaCd" name="areaCd">
                                           <option value="">구역 선택</option>
                                           <c:forEach items="${area_cd_list}" var="item" varStatus="status">
                                               <c:choose>
                                                   <c:when test="${item.scode == rtn.obj.areaCd}">
...
<form:form commandName="search" id="searchForm" name="searchForm">
    ...
    <input type="hidden" name="searchWorkshopNm" value="${search.searchWorkshopNm}"/>
</form:form>
<script>
