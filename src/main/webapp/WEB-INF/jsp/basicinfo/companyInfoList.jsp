        ...
        (function($) {
            $(function(){
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/companyInfoDtlPage.do'/>";
                    frm.submit();
                });
                ...
                <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="businNo"   value="${search.businNo}"/>
                                                   ...
                                                   <div style="float: right; margin: 6px 5px;">
                                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="전화번호" id="telNo" name="telNo" value="${search.telNo}" />
                                                   </div>
                                                   <div style="float: right; margin: 6px 5px;">
                                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="상호명" id="mutualNm" name="mutualNm" value="${search.mutualNm}" />
                                                   </div>
                                               </form:form>
                                           </div> 
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">  
                                                  <tr role="row">
                                                      ...
                                                      <th id="busin_no"       class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 12%;">사업자번호</th>
                                                      <th id="mutual_nm"      class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 15%;">상호</th>
                                                      <th id="ceo_nm"         class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">대표명</th>
                                                      <th id="addr"           class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 37%;">주소</th>
                                                      <th id="busin_cond"     class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">업종형태</th>
                                                      <th id="parts_category" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">업종</th>
                                                      <th id="tel_no"         class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">전화번호</th>
                                                      <th id="fax_no"         class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">팩스번호</th>
<!--                                                       <th id="write_dt"       class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">등록일시</th> -->
<!--                                                       <th id="update_dt"      class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">수정일시</th> -->
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="busin_no">${item.businNo}</span></td>
                                                        <td class="text-ellipsis"><span class="mutual_nm"><a href="javascript:fn_go_dtl_page('${item.businNo}')">${item.mutualNm}</a></span></td>
                                                        <td class="text-ellipsis"><span class="ceo_nm">${item.ceoNm}</span></td>
                                                        <td class="text-ellipsis"><span class="addr">${item.addr}</span></td>
                                                        <td class="text-ellipsis"><span class="busin_cond">${item.businCond}</span></td>
                                                        <td class="text-ellipsis"><span class="parts_category">${item.partsCategory}</span></td>
                                                        <td class="text-ellipsis"><span class="tel_no">${item.telNo}</span></td>
                                                        <td class="text-ellipsis"><span class="fax_no">${item.faxNo}</span></td>
<%--                                                         <td class="text-ellipsis"><span class="write_dt">${item.writeDt}</span></td> --%>
<%--                                                         <td class="text-ellipsis"><span class="update_dt">${item.updateDt}</span></td> --%>
                                                    </tr>
                                                  </c:forEach>
