            ...
            $(function(){
                ...
                $("#excel_upload").dialog({
                     ...
                     buttons: [
                     {
                         ...
                         $.ajax({
                                      url : "<c:url value='/uploadMaterialExcel.do'/>",
                                      type: 'POST',
                                      data: JSON.stringify(arrMcc010),
                                      ...
                                      success: function(data) {
                                          ...
                                          $( "#glvLink" ).html("<c:url value='/materialListPage.do'/>");
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/materialDtlPage.do'/>";
                    frm.submit();
                });
...
<body>
                ...
                <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">자재 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="matNm" value="${search.matNm}"/>
                                                   ...
                                                   <div style="float: right; margin: 6px 5px;">
                                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="자재명" id="searchMatNm" name="searchMatNm" value="${search.searchMatNm}" />
                                                   </div>
                                               </form:form>
                                           </div>
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
                                                      ...
                                                      <th id="mat_nm"     	class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 25%;">자재명</th>
                                                      <th id="mat_cust_cd"	class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">자재처</th>
                                                      <th id="mat_item_nm"	class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">품명</th>
                                                      <th id="mat_size"  class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">규격</th>
                                                      <th id="write_id" 	class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">등록자</th>
                                                      <th id="write_dt" 	class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">등록일</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="mat_nm"><a href="javascript:fn_go_dtl_page('${item.matNm}')">${item.matNm}</a></span></td>
                                                        <td class="text-ellipsis"><span class="mat_cust_cd">${item.matCustNm}</span></td>
                                                        <td class="text-ellipsis"><span class="mat_item_nm">${item.matItemNm}</span></td>
                                                        <td class="text-ellipsis"><span class="mat_size">${item.matSize}</td>
    ...
    <div id="excel_upload" title="확인" style="display:none;">
...
function handleExcelDataJson(sheet){
    ...
    for(var i=0; i<sheetData.length; i++) {
        ...
        mpo012.badCd	= sheetData[i]["불량코드"];
        mpo012.badQty	= sheetData[i]["불량수량"];
        mpo012.useYn    = "Y";
