        ...
        (function($) {
            $(function(){
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/itemGrpMiddleDtlPage.do'/>";
                    frm.submit();
                });
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           ...
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">제품 중분류 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="itmgpCd" value="${search.itmgpCd}"/>
								                   ...
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="중분류명" id="searchItmgpNm" name="searchItmgpNm" value="${search.searchItmgpNm}" />
								                   </div>
								                   <div style="float: right; margin: 6px 5px;">
								                       <input type="text" class="form-control input-lg radius" size="35" placeholder="대분류명" id="searchMatgpNm" name="searchMatgpNm" value="${search.searchMatgpNm}" />
								                   </div>
								               </form:form>
                                           </div> 
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="matgp_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 20%;">대분류명</th>
	                                                  <th id="itmgp_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 30%;">중분류명</th>
	                                                  <th id="c.login_name" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">등록자</th>
	                                                  <th id="a.write_dt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">등록일시</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="matgp_nm">${item.matgpNm}</span></td>
					                                    <td class="text-ellipsis"><span class="itmgp_nm"><a href="javascript:fn_go_dtl_page('${item.itmgpCd}')">${item.itmgpNm}</a></span></td>
					                                    <td class="text-ellipsis"><span class="c.login_name">${item.writeNm}</span></td>
					                                    <td class="text-ellipsis"><span class="a.write_dt">${item.writeDtStr}</span></td>
					                                </tr>
					                              </c:forEach>
