                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">
                                                  <tr role="row">
	                                                  ...
	                                                  <th id="yyymmdd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">일자</th>
	                                                  <th id="day_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">요일</th>
	                                                  <th id="work_yn" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">근무여부</th>
	                                                  <th id="yweek_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">연주차</th>
	                                                  <th id="mweek_cd" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">월주차</th>
	                                                  <th id="bigo" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 30%;">비고</th>
                                                  </tr>
                                              </thead>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><span class="yyymmdd">${item.yyymmdd}</span></td>
					                                    <td class="text-ellipsis"><span class="day_nm">${item.dayNm}</span></td>
					                                    <td class="text-ellipsis"><span class="work_yn">${item.workYn}</span></td>
					                                    <td class="text-ellipsis"><span class="yweek_cd">${item.yweekCd}</span></td>
					                                    <td class="text-ellipsis"><span class="mweek_cd">${item.mweekCd}</span></td>
