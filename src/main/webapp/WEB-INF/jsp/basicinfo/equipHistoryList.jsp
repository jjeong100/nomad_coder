...
<!--
	...
	(function($) {
		$(function() {
			...
			$('#btnCreate').click(function() {
				...
				frm.action = "<c:url value='/equipHistoryDtlPage.do'/>";
				frm.submit();
			});
	...
	//=====================================================================
	function fn_go_dtl_page(equipSeq, equipHisSeq) {
		var frm = document.searchForm;
		frm.crudType.value = 'R';
		frm.equipSeq.value = equipSeq;
		frm.equipHisSeq.value = equipHisSeq;
		frm.action = "<c:url value='/equipHistoryDtlPage.do'/>";
		frm.submit();
	}
			...
			<div class="container-fluid">
				...
				<div class="card mb-4">
					<div class="card-header">
						...
						<div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">설비 점검 이력 추가</div>
					</div>
					<div class="card-body">
									...
									<div class="col-sm-12 col-md-10" style="margin-bottom: 5px;">
										<div id="dataTable_filter" class="dataTables_filter">
											<form:form commandName="search" id="searchForm" name="searchForm">
												...
												<input type="hidden" name="equipHisSeq" value="" />
										...
										<table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout: fixed;">
											<thead class="thead-dark">
												<tr role="row">
													...
													<th id="equip_nm" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 15%;">장비명</th>
													<th id="equip_dt" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10%;">점검일자</th>
													<th id="equip_cont" class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 50%;">점검내용</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${rtn.obj}" var="item" varStatus="status">
													<tr role="row" class="odd">
														...
														<td class="text-ellipsis"><span class="equip_nm"><a href="javascript:fn_go_dtl_page('${item.equipSeq}', '${item.equipHisSeq}')">${item.equipNm}</a></span></td>
														<td class="text-ellipsis"><span class="equip_dt">${item.equipDt}</span></td>
														<td class="text-ellipsis"><span class="equip_cont">${item.equipCont}</span></td>
													</tr>
												</c:forEach>
