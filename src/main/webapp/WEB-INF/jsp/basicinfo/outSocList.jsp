        ...
        (function($) {
            $(function(){
                ...
                $('#btnCreate').click(function() {
                    ...
                    frm.action = "<c:url value='/outSocDtlPage.do'/>";
                    frm.submit();
                });
                ...
                <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           <sapn>외주자재 거래 목록</sapn>
                           <div id="btnExcel" class="btn btn-primary btn-sm mr-2" style="float: right;">엑셀다운로드</div>
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">거래 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="outSocSeq"   value="${search.outSocSeq}"/>
                                                   ...
                                                   <div style="float: right; margin: 6px 5px;">
                                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="자재명" id="searchOutMatNm" name="searchOutMatNm" value="${search.searchOutMatNm}" />
                                                   </div>
                                                   <div style="float: right; margin: 6px 5px;">
                                                       <input type="text" class="form-control input-lg radius" size="35" placeholder="업체명" id="searchOutCustNm" name="searchOutCustNm" value="${search.searchOutCustNm}" />
                                                   </div>
                                               </form:form>
                                           </div> 
                                       </div>
                                           ...
                                           <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout:fixed;">
                                              <thead class="thead-dark">  
                                                  <tr role="row">
                                                      ...
                                                      <th id="out_soc_sdt"	class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 15%;">거래일시</th>
                                                      <th id="out_mat_cd"	class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 20%;">자재명</th>
                                                      <th id="out_cust_cd"	class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 20%;">외주자재처</th>
                                                      <th id="out_mat_qty"	class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 15%;">수량</th>
                                                      <th id="write_id"     class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 10%;">등록자</th>
                                              ...
                                              <tbody>
                                                  <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-ellipsis"><span class="out_soc_sdt"><a href="javascript:fn_go_dtl_page('${item.outSocSeq}')">${item.outSocSdt}</a></span></td>
                                                        <td class="text-ellipsis"><span class="out_mat_cd">${item.outMatNm}</span></td>
                                                        <td class="text-ellipsis"><span class="out_cust_cd">${item.outCustNm}</span></td>
                                                        <td class="text-ellipsis"><span class="out_mat_qty"><fmt:formatNumber value="${item.outMatQty}" pattern="###,###"/></span></td>
                                                        <td class="text-ellipsis"><span class="write_id">${item.writeNm}</span></td>
                                                        <td class="text-ellipsis"><span class="write_dt">${item.writeDtStr}</span></td>
                                                    </tr>
                                                  </c:forEach>
