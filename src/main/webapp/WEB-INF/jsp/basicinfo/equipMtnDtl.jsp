    ...
    <script type="text/javaScript" language="javascript" defer="defer">
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/equipMtnSaveAct.do'/>"
        ...
        function fn_btn_show_hide() {
        	if (document.objForm.crudType.value == 'R') {
                ...
                $('.card-body input, textarea').attr("readOnly",true);
                ...
                $('.card-body input, textarea').attr("readOnly",false);
		...
		function fn_submit_validation() {
            if($("#equipChkDt").val().trim() == '') {
                alert(MSG_COM_ERR_001.replace("[@]", " : 점검수리일자"));
                $("#equipChkDt").focus();
                return false;
            }

            if($("textarea[name='equipChkCont']").val().trim() == '') {
                alert(MSG_COM_ERR_001.replace("[@]", " : 점검내용"));
                $("#textarea[name='equipChkCont']").focus();
                return false;
            }
			...
			<main>
				<div class="container-fluid">
					...
					<form name="objForm" id="objForm">
						...
						<input type="hidden" name="equipMtnSeq" value="${rtn.obj.equipMtnSeq}" />
								...
								<div class="form-row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="small mb-1" for="custNm" style="display: block;">점검수리일자</label>
											<input class="form-control3 py-4" id="equipChkDt" name="equipChkDt" type="text" value="${rtn.obj.equipChkDt}" placeholder="점검수리일자을 입력하세요">
										</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="small mb-1" for="equipChkCont" style="display: block;">점검내용</label>
											<textarea name="equipChkCont" class="form-control" rows="6">${rtn.obj.equipChkCont}</textarea>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="small mb-1" for="equipEtc" style="display: block;">기타</label>
											<textarea name="equipEtc" class="form-control" rows="6">${rtn.obj.equipEtc}</textarea>
										</div>
									</div>
								</div>
							</div>
