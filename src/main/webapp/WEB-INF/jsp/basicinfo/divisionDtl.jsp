        ...
        (function($) {
            $(function(){
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/divisionSaveAct.do'/>"
                                		            ,$('#objForm').serialize(),'삭제 되었습니다.'
                                		            ,'searchForm'
                                		            ,"<c:url value='/divisionListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
                ...
                $('#btnUpdate').click(function() {
                	if($("#departCd").val().trim() == ''){
                        alert(MSG_COM_ERR_001.replace("[@]", " : 부서 코드"));
                        $("#departCd").focus();
                        return false;
                    }
                	if($("#departNm").val().trim() == ''){
                        alert(MSG_COM_ERR_001.replace("[@]", " : 부서명"));
                        $("#departNm").focus();
                        return false;
                    }
                           ...
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="departCd">부서코드</label>
                                       <input class="form-control" id="departCd" name="departCd" type="text" value="${rtn.obj.departCd}" placeholder="부서코드를 입력하세요">
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="departNm">부서명</label>
                                       <input class="form-control" id="departNm" name="departNm" type="text" value="${rtn.obj.departNm}" placeholder="부서명을 입력하세요">
                                   </div>
                               </div>
                           </div>
...
<form:form commandName="search" id="searchForm" name="searchForm">
    ...
    <input type="hidden" name="departNm" value="${search.departNm}"/>
</form:form>
<script>
