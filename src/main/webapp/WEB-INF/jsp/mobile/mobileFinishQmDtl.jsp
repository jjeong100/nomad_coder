				...
				buttons : [ {
					...
					click : function() {
						...
						cfAjaxCallAndGoLink("<c:url value='/finishQmSaveAct.do'/>", $('#objForm').serialize()
								, '삭제 되었습니다.', 'searchForm'
								, "<c:url value='/mobileFinishQmListPage.do'/>");
					}
				}, {
					text : "취소",
					click : function() {
	...
	function fn_DelRowFinishQmBad(mqcBadSeq, index) {
		if( cfIsNull(mqcBadSeq) ) {
	        ...
	        param.callback = function(result) {
	        	...
	        	$( "#glvLink" ).html("<c:url value='/mobileFinishQmDtlPage.do'/>");
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control3 pt-2" id="qmCheckdt" name="qmCheckdt" type="text" value="${rtn.obj.qmCheckdt}" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
