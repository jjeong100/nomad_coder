...
<body>
	<form:form commandName="obj" id="objForm" name="objForm">
		...
		<div id="container">
			<div class="card">
				<div class="card-body card-roundbox pr-sm-5 pl-sm-5 embed-responsive" style="height:500px; overflow:auto">
									...
									<tbody id="workactListBody">
										<c:forEach items ="${productionActList}" var="item" varStatus="status">
											<tr role="row" class="odd" data-row="${item.workactSeq}">
												...
												<%-- <td class="text-center"><span name="btnWorkactView" class="btn btn-primary btn-sm" data-key="${item.workactSeq}" title="보기">보기</span></td> --%>
											</tr>
										</c:forEach>
									</tbody>
								</table>
	...
	<jsp:include flush="false" page="/WEB-INF/jsp/popup/mobilePopWorkactEnd.jsp" ></jsp:include>
