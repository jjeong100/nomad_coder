                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                cfAjaxCallAndGoLink("<c:url value='/itemInSaveAct.do'/>"
                                                    ...
                                                    ,'searchForm'
                                                    ,"<c:url value='/mobileItemInListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control3 pt-2" id="qmCheckdt" name="qmCheckdt" type="text" value="${prodOrderVo.qmCheckdt}" readonly />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control3 pt-2" id="iteminDt" name="iteminDt" type="text" value="${rtn.obj.iteminDt}" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
