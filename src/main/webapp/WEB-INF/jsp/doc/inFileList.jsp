        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/inFileListPage.do'/>";
                    frm.submit();
		        });
...
<body>
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           <sapn>수입검사성적서 목록</sapn>
                           <div id="btnExcel" class="btn btn-primary btn-sm mr-2" style="float: right;">엑셀다운로드</div>
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">수입성적서 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="searchDocTypeCd" value="IN"/>
	...
	<div id="docReportModal" title="성적서등록" >
	    <form:form id="fileForm" name="fileForm" action="<c:url value='/docSaveAct.do'/>" enctype="multipart/form-data">
		    ...
		    <input type="hidden" name="docTypeCd" value="IN"/>
