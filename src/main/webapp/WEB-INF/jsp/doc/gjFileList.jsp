        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/gjFileListPage.do'/>";
                    frm.submit();
		        });
...
<body>
		        ...
		        <div class="container-fluid">
                   ...
                   <div class="card mb-4">
                       <div class="card-header">
                           <sapn>공정검사성적서 목록</sapn>
                           <div id="btnExcel" class="btn btn-primary btn-sm mr-2" style="float: right;">엑셀다운로드</div>
                           <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">공정성적서 추가</div>
                       </div>
                       <div class="card-body">
                                       ...
                                       <div class="col-sm-12 col-md-10" style="margin-bottom:5px;">
                                           <div id="dataTable_filter" class="dataTables_filter">
                                               <form:form commandName="search" id="searchForm" name="searchForm">
                                                   ...
                                                   <input type="hidden" name="searchDocTypeCd" value="GJ"/>
                                              ...
                                              <tbody>
	                                              <c:forEach items ="${rtn.obj}" var="item" varStatus="status">
					                                <tr role="row" class="odd">
					                                    ...
					                                    <td class="text-ellipsis"><div name="btnDelete" class="btn btn-primary btn-sm mr-2" onclick="javascript:fn_delete('${item.docSeq}');">삭제</div></td>
					                                </tr>
					                              </c:forEach>
	...
	<div id="docReportModal" title="성적서등록" >
	    <form:form id="fileForm" name="fileForm" action="<c:url value='/docSaveAct.do'/>" enctype="multipart/form-data">
		    ...
		    <input type="hidden" name="docTypeCd" value="GJ"/>
