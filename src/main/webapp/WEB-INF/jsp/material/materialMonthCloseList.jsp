        ...
        (function($) {
            $(function(){
                ...
                $('#btnSearch').click(function() {
                    ...
                    frm.action = "<c:url value='/materialMonthCloseListPage.do'/>";
                    frm.submit();
                });
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                $( this ).dialog( "close" );
                                cfAjaxCallAndGoLink("<c:url value='/createMonthClose.do'/>",$('#objForm').serialize(),'마감 처리 되었습니다.','searchForm',"<c:url value='/materialMonthCloseListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                $( this ).dialog( "close" );
                                cfAjaxCallAndGoLink("<c:url value='/createMonthClose.do'/>",$('#objForm').serialize(),'마감 해제 되었습니다.','searchForm',"<c:url value='/materialMonthCloseListPage.do'/>");
                            }
                        },
                        {
                            text: "취소",
