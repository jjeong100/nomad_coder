    ...
    (function($) {
        $(function() {
            ...
            $('#btnCreate').click(function() {
                ...
                frm.action = "<c:url value='/materialOutDtlPage.do'/>";
                frm.submit();
            });
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div id="btnCreate" class="btn btn-primary btn-sm mr-2" style="float: right;">자재출고</div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div id="dataTable_filter" class="dataTables_filter">
                                            <form:form commandName="search" id="searchForm" name="searchForm">
                                                ...
                                                <div style="float: right; margin: 6px 5px;">
                                                    <input class="form-control2" id="searchMatNm" name="searchMatNm" type="text" value="${search.searchMatNm}" placeholder="자재명" />
                                                </div>
                                        ...
                                        <table class="table table-borderless table-borderbottom dataTable table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; table-layout: fixed;">
                                            <thead class="thead-dark">
                                                <tr role="row">
                                                    ...
                                                    <th id="workshop_cd"     class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 8%;">창고</th>
                                                    <th id="mat_cd"          class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">자재명</th>
                                                    <th id="lotid"           class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 12%;">입고LOT</th>
                                                    <th id="out_cnt"         class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 8%;">수량</th>
